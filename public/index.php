...
<head>
    ...
    <link rel="stylesheet" href="css/cust_video.css">
...
<body class="text-primary font-sans leading-snug">
    ...
    <header class="sm:w-full sm:z-50 sm:mb-8">
        <div class="top-info-text"><span>-Advertorial-</span></div>
        <div class="container relative flex justify-between items-center mx-auto py-4 mb-6 sm:mb-0">
            ...
            <div class="flex w-1/2 justify-end">
                <img src="images/rus.png" alt="rus">
            </div>
        </div>
    </header>

    <div
        class="fixed z-50 w-53 h-13 rounded-custom-right py-2 px-3 flex flex-col bg-secondary text-white shadow text-center left-0 sm:hidden fix-info">
        <span id="rand_man">99</span>
        <span class="tracking-wide whitespace-no-wrap">
            ЧЕЛОВЕК НА СТРАНИЦЕ
        </span>
    </div>
    <div
        class="fixed z-50 w-53 h-13 rounded-custom-left py-2 px-3 flex flex-col bg-secondary text-white shadow text-center right-0 sm:hidden fix-info">
        <span id="rand_places">19</span>
    ...
    <main class="">
        <section class="container mx-auto mb-16 sm:mb-12 pt-4 sm:pt-0">
            <h1
                ...
                Газпром разрешил торговать газом
            </h1>
        ...
        <section id="about" class="container mx-auto mb-24 sm:mb-24">
            <div class="w-full flex justify-center items-center sm:flex-col about_main">

                <div
                    class="relative pr-2 w-2/3 flex sm:pr-0 sm:w-full sm:mr-0 js-vid1 sm:mb-12 sm:block about_video-wrapper">
                    <div class="video-wrapper embed-responsive">
                ...
                <div class="pl-6 block w-1/3 sm:p-0 sm:w-full about_form-wrapper">
                    <form
                        class="block bg-white sm:shadow-none sm:bg-transparent rounded-custom shadow-form text-primary  w-full pt-6 pb-4 px-6 sm:pt-2 sm:px-4 sm:leading-tight neo_form"
                        id="myform" method="POST" action="send.php">
                        <div class="preloader"></div>
                        <h3 class="text-2xl text-center font-bold font-ubuntu mb-6 sm:mb-10">Начните зарабатывать на
                            государственном газе!</h3>
                        <div class="flex flex-col mb-8 sm:mb-10">
                            <input class="pl-0 p-2 border-b border-primary sm:bg-transparent focus:outline-none"
                                name="firstname" type="text" value="" placeholder="Имя" required>
                        </div>
                        <div class="flex flex-col mb-8 sm:mb-10">
                            <input class="pl-0 p-2 border-b border-primary sm:bg-transparent focus:outline-none"
                                name="lastname" type="text" value="" placeholder="Фамилия" required>

                        </div>
                        <div class="flex flex-col mb-8 sm:mb-10">
                            <input class="pl-0 p-2 border-b border-primary sm:bg-transparent focus:outline-none"
                                name="email" type="email" value="" placeholder="Электронная почта" required>
                        </div>
                        <div class="row">
                            <div style="display: flex; justify-content: center; align-items: center;" class="border-b border-primary">
                                <div style="display: flex; padding: 5px 15px 5px 5px; background-color: aliceblue;"><img src="images/flag_r.jpg" width="30" style="padding-right: 5px;" alt="flag"><b>+7</b></div>
                                <input
                                    class="pl-0 p-2   sm:bg-transparent focus:outline-none  phone"
                                    style="width: 100%; padding-bottom: 6px; padding-left: 5px;" name="phone_number" type="tel" pattern="[0-9]{7,10}" maxlength="10" required>
                                </div>
                        </div>

                        <div class="flex mb-4 justify-center" style="margin-top: 13px">
                            <button
                                class="btn btn_send w-56 font-sans font-bold transition bg-btn-primary hover:bg-btn-hover text-white rounded py-3"
                                type="submit">Начать зарабатывать
                            </button>
                        </div>
                        <div class="checkbox-svg">
                            <input type="checkbox" id="cbx-3" style="display: none;">
                            <label for="cbx-3" class="checked-svg">
                            ...
                            <div class="privacy-checkbox">
                                <p>
                                    Я даю согласие на сбор адреса моей электронной почты в целях получения коммерческих
                                    предложений, которые, по нашему мнению, будут представлять интерес для вас от имени
                                    компаний и отраслей, подробно описанных в наших
            ...
            <div class="w-full sm:flex sm:flex-col">
                <div class="inline-block sm:float-none float-left sm:-ml-4 sm:w-screen w-2/5">
                    <article class="p-8 sm:py-20 sm:px-4 flex flex-col bg-primary text-white">
                        <h3 class="text-4xl sm:text-3xl font-ubuntu font-bold mb-8 sm:mb-16">Почему это выгодно <br> для
                            обычных граждан</h3>
                        <div class="flex items-center mb-12">
                            <div class="w-1/5" style="height: 100px;">
                        ...
                        <div class="flex items-center mb-12">
                            <div class="w-1/5" style="height: 100px;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewbox="0 0 80 80"
                                    fill="none">
                                    <g>
                                        <path d="M63.1001 48.1143H16.8987V53.1139H63.1001V48.1143Z" fill="#5C9EFF" />
                                        <path d="M63.1001 26.8857H16.8987V48.1138H63.1001V26.8857Z" fill="#94C1FF" />
                                        <path
                                        ...
                                        <path
                                            ...
                                            fill="#94C1FF" />
                                        <path d="M63.1001 26.8857H16.8987V28.1373H63.1001V26.8857Z" fill="#D7E9FF" />
                                        <path d="M63.1001 46.8623H16.8987V48.2196H63.1001V46.8623Z" fill="#5C9EFF" />
                                        <path d="M18.1468 28.1377H16.8987V46.8626H18.1468V28.1377Z" fill="#D7E9FF" />
                                        <path d="M63.1002 28.1377H61.8514V46.8626H63.1002V28.1377Z" fill="#5C9EFF" />
                                        <path d="M48.1171 26.8857H31.8828V48.1138H48.1171V26.8857Z" fill="white" />
                                        <path d="M48.1171 48.1143H31.8828V53.1139H48.1171V48.1143Z" fill="#D7E9FF" />
                                        <path
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewbox="0 0 80 80"
                                    ...
                                    <g>
                                        ...
                                        <path
                                            ...
                                            fill="#94C1FF" />
                                        <path d="M34.577 51.2495L34.627 57.4993H27.1895V51.2495H34.577Z" fill="white" />
                                        ...
                                        <path d="M44.4263 33.7505L44.6143 40.0001H37.0145L36.9645 33.7505H44.4263Z"
                                            fill="#5C9EFF" />
                                        <path d="M34.5268 42.5L34.5648 48.7498H27.1895V42.5H34.5268Z" fill="white" />
                                        ...
                                        <path d="M15.1649 33.7505L14.9403 40.0001H7.34058L7.70297 33.7505H15.1649Z"
                                            fill="#5C9EFF" />
                                        <path d="M24.6895 42.5V48.7498H17.1519L17.3777 42.5H24.6895Z" fill="white" />
                                        <path d="M14.8781 42.5L14.6522 48.7498H6.87793L7.24032 42.5H14.8781Z"
                                            fill="white" />
                                        <path d="M24.6897 51.25V57.4998H16.853L17.0776 51.25H24.6897Z" fill="white" />
                ...
                <div class="pl-8 inline-block sm:float-none float-left sm:w-screen sm:-ml-4 sm:p-0 w-3/5">
                    <article class="p-8 sm:pt-20 sm:pb-12 sm:px-4 flex flex-col bg-secondary text-white what-block">
                        <h3 class="text-4xl sm:text-3xl sm:mb-16 font-bold font-ubuntu mb-8">Что нужно сделать, чтобы
                            начать
                            зарабатывать c Газпром уже сейчас?</h3>
                        <ul class="text-lg">
                            <li class="mb-10 flex items-start"><span
                                    class="mt-3 w-4 h-1 bg-white inline-block mr-4 sm:flex-shrink-0 sm:w-3"></span>Зарегистрироваться
                                на данном сайте в форме выше
                            </li>
                            <li class="mb-10 flex items-start"><span
                                    class="mt-3 w-4 h-1 bg-white inline-block mr-4 sm:flex-shrink-0 sm:w-3"></span>Дождаться
                                звонка от консультанта компании Газпром и подтвердить регистрацию
                            </li>
                            <li class="mb-10 flex items-start"><span
                                    class="mt-3 w-4 h-1 bg-white inline-block mr-4 sm:flex-shrink-0 sm:w-3"></span>Выбрать
                                желаемую сумму на счет и уже через 30 дней получить первый доход
                            </li>
                        </ul>
                    </article>
                </div>
            ...
            <div class="w-full flex sm:flex-col-reverse">
                <div class="pt-18 inline-block w-2/5 text-primary sm:p-0 sm:w-full">
                    <article class="flex flex-col text-lg sm:text-base">
                        <h4 class="text-2xl font-ubuntu font-bold mb-2">Алексей Миллер</h4>
                        <h5 class="text-black opacity-50 mb-10 sm:mb-6">председатель правления совета <br> директоров
                            ПАО
                            «Газпром»</h5>
                        <p class="mb-8 sm:leading-relaxed">
                            Мы приняли решение открыть доступ к торгам для всех граждан страны, поскольку это будет
                            выгодно
                            как для Газпрома, так и для россиян.
                            <br><br>
                            Дело в том, что на данный момент российский газ становится самым востребованным на мировом
                            рынке. Во всех странах мира стремительно растет спрос на его покупку. По этой причине мы
                            решили
                            увеличить объемы производства газа в 4 раза и привлечь людей со всей России в качестве
                            инвесторов.
                            <br><br>
                            Поскольку цены на газ сейчас быстро меняются, все, кто участвуют в проектах Газпрома,
                            получают в
                            среднем по $800-$8,500 дохода ежемесячно.
                        </p>
                        <div class="text-base">
                            <a href="#about"
                                class="inline-block  text-center w-56 font-sans font-bold transition bg-btn-primary hover:bg-btn-hover text-white rounded py-3">Проконсультироваться</a>
                        </div>
                    </article>
                </div>
                <div
                    class=" -mt-24 sm:mt-0 sm:-ml-4 sm:p-0 sm:w-screen sm:mb-8 sm:overflow-hidden pl-8 relative inline w-3/5 text-primary photo-adapt">
                    <img class="sm:-mt-12" src="images/photo.jpg" alt="photo">
                </div>
            </div>
        </section>
                ...
                <div class="flex flex-col w-2/5 items-center bg-white md:w-4/5 sm:w-full ">
                    <form action=""
                        ...
                        <div class="flex flex-col text-center font-bold mb-4 sm:mb-10 px-5">
                            ...
                            <input type="text" class="js-range-slider irs-hidden-input" name="my_range" value="150"
                                tabindex="-1" readonly>
                        </div>
                        ...
                        <div class="flex mb-4 justify-center">
                            <a href="#about" class="inline-block  text-center w-56 font-sans font-bold transition bg-btn-primary hover:bg-btn-hover
            ...
            <div class="w-full sm:flex sm:flex-col">
                <div class="inline-block sm:float-none sm:-ml-4 sm:w-screen w-1/2">
                    <div class="license-block">
                        <p class="mb-2">
                            <span class="text-extra-bold">Лицензия</span>
                            №045-13980-02000 От 13.12.2019 Профессиональной и биржевой деятельности по ценным бумагам
                            <span class="block text-extra-bold">ПАО "Государственная платформа Газпром"</span>
                        </p>
                        <a data-fancybox="gallery" class="license-img fancy-img" href="images/license.jpg">
                            <img src="images/license.jpg" alt="Лицензия" class="w-1/2 mx-auto">
                        </a>
                    </div>
                    <a data-fancybox="gallery1"
                        class="inline-block mt-2 text-center w-56 font-sans font-bold transition bg-btn-primary hover:bg-btn-hover text-white rounded py-3 fancy-img"
                        href="images/license.jpg">Увеличить фото</a>
                </div>
            </div>
        </div>

        <section id="posts" class="w-full mb-20">
            <h2 class="mb-8 text-4xl sm:text-3xl font-bold font-ubuntu text-center">Проекты Газпрома, открытые для
                участия</h2>
            <div class="text-white flex sm:flex-wrap">
                <div class="w-1/3 sm:w-full">
                    <article class="flex post items-end">
                        <div class="absolute w-full h-full top-0 left-0 post-wrapper">
                            <img class="h-full sm:h-auto sm:w-full tr-center" src="images/image 51.jpg" alt="">
                        </div>
                        <div class="relative z-10 p-8 sm:px-4">
                            ...
                            <p class="mb-8 text-lg sm:text-base">Крупнейшая система транспортировки газа
                                на востоке России</p>
                            <div>
                                <a href="#about"
                                    class="inline-block px-4 font-sans font-bold transition bg-btn-primary hover:bg-btn-hover text-white rounded py-3">Подать
                                    заявку</a>
                            </div>
                        </div>
                    </article>
                ...
                <div class="w-1/3 sm:w-full">
                    <article class="flex post items-end">
                        <div class="absolute w-full h-full top-0 left-0 post-wrapper">
                            <img class="h-full tr-center sm:h-auto sm:w-full" src="images/image 53.jpg" alt="">
                        </div>
                        <div class="relative z-10 p-8 sm:px-4">
                ...
                <div class="w-1/3 sm:w-full">
                    <article class="flex post items-end">
                        <div class="absolute w-full h-full top-0 left-0 post-wrapper">
                            <img class="h-full sm:h-auto sm:w-full tr-center" src="images/image 52.jpg" alt="">
                        </div>
                        <div class="relative z-10 p-8 sm:px-4">
                            ...
                            <div>
                                <a href="#about"
                                    class="inline-block text-center px-4 font-sans font-bold transition bg-btn-primary hover:bg-btn-hover text-white rounded py-3">Подать
                                    заявку</a>
                            </div>
                        </div>
                    </article>
                ...
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewbox="0 0 128 128" fill="none">
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            fill="currentColor" />
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M122.353 37.254L84.6547 58.7958H71.5204L122.353 29.8325V37.254Z" fill="currentColor" />
                    </svg>
                </div>
            </div>
        </section>
    ...
    <div class="pt-8 pb-8 bg-primary">
        <section class="container mx-auto flex justify-center pb-12 pt-12">
            <div class="flex flex-col w-2/5 items-center bg-white md:w-4/5 sm:w-full ">
                <form
                    class="block bg-white sm:shadow-none sm:bg-transparent rounded-custom shadow-form text-primary  w-full pt-6 pb-4 px-6 sm:pt-2 sm:px-4 sm:leading-tight bottom-form-custom neo_form"
                    id="myform2" method="POST" action="send.php">
                    <div class="preloader"></div>
    ...
    <footer>
        <div class="container mx-auto py-4 text-center sm:leading-relaxed opacity-50 sm:text-xs">
            *Все результаты работы в данной сфере индивидуальны и зависят от каждого клиента
            ПАО "ГазПромИнвестинг" ул. Тимура Фрунзе, д. 11, Москва, Россия, 119034, БЦ «Демидов» <a href="privacy.html"
                target="_blank">Политика
                конфиденциальности</a> ©2019-<script>
                document.write(new Date().getFullYear())
            </script> ГазПромИнвестинг
        </div>
    </footer>
    <script>
        var countryCodePost = "";
    ...
    <script>
        $('#rand_man').text(Math.floor(Math.random() * (130 - 99 + 1)) + 99);
        $('#rand_places').text(Math.floor(Math.random() * (19 - 9 + 1)) + 9);
    </script>
